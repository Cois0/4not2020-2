...
const MaquinaLavar = require('../models/MaquinaLavar')
...
controller.novo = async (req, res) => {
   ...
   try {
    await MaquinaLavar.create(req.body)
    // http 201: Created
    res.status(201).end()
   }
   catch(erro) {
...
controller.listar = async (req, res) => {
    ...
    let dados = await MaquinaLavar.find()
        .populate('pedido') 
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await MaquinaLavar.findById(id)
...
controller.atualizar = async (req, res) => {
   try{
    ...
    let ret = await MaquinaLavar.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    ...
    let ret = await MaquinaLavar.findByIdAndDelete(id)
