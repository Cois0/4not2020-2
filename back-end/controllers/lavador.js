...
const Lavador = require('../models/Lavador')
...
controller.listar = async (req, res) => {
    ...
    let dados = await Lavador.find()
        .populate('maquina_lavar') 
        .populate('prancha_passar')
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Lavador.findById(id)
...
controller.atualizar = async (req, res) => {
   try{
    ...
    let ret = await Lavador.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    ...
    let ret = await Lavador.findByIdAndDelete(id)
