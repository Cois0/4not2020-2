...
const PranchaPassar = require('../models/PranchaPassar')
...
controller.novo = async (req, res) => {
   ...
   try {
    await PranchaPassar.create(req.body)
    // http 201: Created
    res.status(201).end()
   }
   catch(erro) {
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await PranchaPassar.findById(id)
...
controller.atualizar = async (req, res) => {
   try{
    ...
    let ret = await PranchaPassar.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    ...
    let ret = await PranchaPassar.findByIdAndDelete(id)
